...
## 1.2.0
`2024-5-30`
- 🔥【new feature】Supports AI datasets and improves AI accuracy. [Documentation](/docs/ai-chat/ai-data-collection)
- 🔥【New function】Support MongoDB database
- 🔥【New function】Supports the openGauss database
- 🔥【New function】Supports the SUNDB database
- 🐞【Fixes】bugs such as tree node search
- ⚡️【Optimization】View all tables visually and functionally
- ⚡️【Optimization】In the result display mode, insert, update, etc., will not occupy a Tab
- ⚡️【Optimization】Locating problems in the Tab bar of Console and adding column locating problems when modifying tables
- ⚡️ Visual optimization
