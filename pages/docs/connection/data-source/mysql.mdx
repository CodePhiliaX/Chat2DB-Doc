...
Use Chat2DB to quickly connect to the Mysql server.

## Official Documentation and Software:

- For complete information about MySQL, please refer to the [Official Documentation](https://dev.mysql.com/doc/)
- To download the MySQL database software, please refer to [Official Software Download](https://dev.mysql.com/doc/mysql-getting-started/en/#mysql-getting-started-installing)

## Step 1: Create a new connection

In the **toolbar**, click the **New** icon (+), navigate to **Data Source** and select **MySQL**.
...
- `URL`: Mysql connection URL, optional, if not filled in, it will be automatically generated according to the above information
- `Driver`: Mysql Driver, optional, if not filled, it will be automatically identified according to the URL, or you can select it manually, and the driver configuration items will be displayed after manual selection
...
If you want to download the JDBC driver for MySQL, click the `Download Driver` download button at the bottom of the dialog box. Of course, you can also manually upload your own driver (`Upload driver`)
