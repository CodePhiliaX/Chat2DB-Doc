...
Use Chat2DB to quickly connect to the SQLServer server.

## Official Documents and Software:

- For complete information about SQLServer, please refer to [Official Documents](https://learn.microsoft.com/en-us/sql/sql-server/?view=sql-server-ver16)
- To download SQLServer database software, please refer to [Official Software Downloads](https://www.microsoft.com/en-us/sql-server/sql-server-downloads)

## Step 1: Create a new connection

In the **Toolbar**, click the **New** icon (+), navigate to **Data Source** and select **SQLServer**.
...
- `URL`: SQLServer connection URL, optional, if not filled in, it will be automatically generated according to the above information

`Driver`: SQLServer driver, optional, if not filled, it will be automatically identified according to the URL, you can also select manually, and the driver configuration items will be displayed after manual selection
...
If you want to download the JDBC driver for SQLServer, click the `Download Driver` download button at the bottom of the dialog box. Of course, you can also manually upload your own driver (`Upload driver`)
