...
用 Chat2DB 快速连接 Mysql 服务器。

## 官方文档和软件：

- 有关 MySQL 的完整信息，请参阅[官方文档](https://dev.mysql.com/doc/)
- 下载 MySQL 数据库软件，请参考[官方软件下载](https://dev.mysql.com/doc/mysql-getting-started/en/#mysql-getting-started-installing)

## 第一步：新建连接

在**工具栏**中，单击**新建**图标 (+)，导航到**数据源**并选择 **MySQL**。
...
如果要下载 MySQL 的 JDBC 驱动程序，请单击对话框底部的`Download Driver`下载按钮，当然也可以手动上传自己的驱动（`Upload driver`）
