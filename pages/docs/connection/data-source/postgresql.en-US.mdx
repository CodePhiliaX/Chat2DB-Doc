...
Use Chat2DB to quickly connect to a Postgresql server.

## Official Documentation and Software:

- For complete information about Postgresql, please refer to the [Official Documentation](https://www.postgresql.org/docs/current/)
- To download the Postgresql database software, please refer to the [Official Software Download](https://www.postgresql.org/download/)

## Step 1: Create a new connection

In the **toolbar**, click the **New** icon (+), navigate to **Data Source** and select **Postgresql**.
...
- `URL`: Postgresql connection URL, optional, if not filled in, it will be automatically generated according to the above information

- `Driver`: Postgresql Driver, optional, if not filled, it will be automatically identified according to the URL, or you can select it manually, and the driver configuration items will be displayed after manual selection
...
If you want to download the JDBC driver for Postgresql, click the `Download Driver` download button at the bottom of the dialog box. Of course, you can also manually upload your own driver (`Upload driver`)
