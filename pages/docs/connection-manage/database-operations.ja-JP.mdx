...
### 6. データベースを右クリックして新しいコンソールを作成し、SQL ファイルを実行し、SQL をエクスポートしてライブラリ名をコピーします。

!['databasemanage'](/image/connection-manage/databasemanage66.png)

ここでは、`Export structure only`または`Export structure and data`を選択できます。
!['データベース管理'](/image/connection-manage/databasemanage88.png)


!['データベース管理'](/image/connection-manage/databasemanage99.png)
