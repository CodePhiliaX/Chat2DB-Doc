...
> If you are completely new to Chat2DB, please read the [Quick Start](https://docs.chat2db.ai/en-US/docs/start-guide/getting-started) guide which gives a quick overview of the first steps to using Chat2DB.
