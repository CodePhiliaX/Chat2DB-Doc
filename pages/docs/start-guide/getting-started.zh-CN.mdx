...
WEB 访问地址：[https://app.chat2db.ai](https://app.chat2db.ai)  &emsp; 客户端下载地址：[https://chat2db.ai/download](https://chat2db.ai/download)
    

## 第一步：客户端下载

如果你使用网页版可以忽略这一步，直接访问 [应用地址](https://app.chat2db.ai) 即可。

客户端下载地址：[客户端下载地址](https://chat2db.ai/download)  选择对应的系统下载安装即可，我们支持Windows、Mac 、Linux。

## 第二步：注册登录

你可以直接通过邮箱获取验证码直接登录，也可以使用第三方登录。目前支持Github、Google等多种登录方式。

[登录地址](https://app.chat2db.ai/login)
