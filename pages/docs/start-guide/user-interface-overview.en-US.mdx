...
The Chat2DB window consists of **a menu bar, a toolbar, a navigation bar, a workspace containing one or more editors and views, and a status bar**:
...
For more information, see [Toolbar Usage](https://docs.chat2db.ai/en-US/docs/connection-manage/database-operations#view-management-database-from-left-to-right)
...
For more Save Console information, see [Save Console Information](https://docs.chat2db.ai/en-US/docs/connection-manage/Using-toolbar#save-consoles)
