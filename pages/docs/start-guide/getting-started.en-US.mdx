...
WEB access address: [https://app.chat2db.ai](https://app.chat2db.ai) &emsp; Client download address: [https://chat2db.ai/download](https://chat2db .ai/download)
...
Client download address: [Client download address](https://chat2db.ai/download) Just select the corresponding system to download and install. We support Windows, Mac, and Linux.
